...
#define SELECTCOUNT 5
#define SELECT_AUDIO_SOURCE 0
#define SELECT_LIGHTS1_COLOR 1
#define SELECT_LIGHTS2_COLOR 2
#define SELECT_LIGHTS3_COLOR 3
#define SELECT_LIGHTS4_COLOR 4
#define SELECT_LIGHTS_CYCLE_SPEED 5
#define TEXTCOUNT 2
