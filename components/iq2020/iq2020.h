...
#define NUMBER_LIGHTS1_INTENSITY 7    // Underwater lights brigthness (0 to 5)
#define NUMBER_LIGHTS2_INTENSITY 8    // Bartop lights brigthness (0 to 5)
#define NUMBER_LIGHTS3_INTENSITY 9    // Pillow lights brigthness (0 to 5)
#define NUMBER_LIGHTS4_INTENSITY 10   // Exterior lights brigthness (0 to 5)
#define NOT_SET -127
